const config = {
  ...
  nasaPowerApi: {
    baseUrl:
      process.env.NASA_POWER_API_BASE_URL || "https://power.larc.nasa.gov/api",
  ...
  weather: {
    defaultHistoricalYears:
      parseInt(process.env.DEFAULT_HISTORICAL_YEARS) || 20,
  ...
  nasaApi: {
    ...
    donkiBaseUrl:
      process.env.NASA_DONKI_BASE_URL || "https://api.nasa.gov/DONKI",
    timeout: parseInt(process.env.NASA_API_TIMEOUT) || 30000,
  },

  noaaSwpc: {
    baseUrl:
      process.env.NOAA_SWPC_BASE_URL || "https://services.swpc.noaa.gov/text",
    timeout: parseInt(process.env.NOAA_SWPC_TIMEOUT) || 30000,
  },

  nasaNeows: {
    baseUrl:
      process.env.NASA_NEOWS_BASE_URL || "https://api.nasa.gov/neo/rest/v1",
    apiKey: process.env.NASA_API_KEY,
  ...
  nasaEonet: {
    baseUrl:
      process.env.NASA_EONET_BASE_URL || "https://eonet.gsfc.nasa.gov/api/v3",
  ...
  nasaEpic: {
    ...
    archiveUrl:
      process.env.NASA_EPIC_ARCHIVE_URL || "https://api.nasa.gov/EPIC/archive",
    apiKey: process.env.NASA_API_KEY,
  ...
  nasaApod: {
    baseUrl:
      process.env.NASA_APOD_BASE_URL || "https://api.nasa.gov/planetary/apod",
    apiKey: process.env.NASA_API_KEY,
